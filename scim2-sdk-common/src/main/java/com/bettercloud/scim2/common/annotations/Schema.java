...
package com.bettercloud.scim2.common.annotations;
...
public @interface Schema
{
  ...
  /**
   * Defines whether it is ok to ignore any unrecognized properties during deserialization.
   * Does not have any effect on serialization.
   *
   * @return A flag indicating if unrecognized properties are allowed during deserialization.
   */
